...
let LoginComponent = class LoginComponent {
    ...
    constructor(router, hardAuthenticateservice) {
        this.router = router;
...
let LogoutComponent = class LogoutComponent {
    constructor(hardAuthenticateservice) {
        this.hardAuthenticateservice = hardAuthenticateservice;
    }
    ngOnInit() {
...
let PasserrorComponent = class PasserrorComponent {
    constructor() {
...
let HardAuthenticateService = class HardAuthenticateService {
    constructor() { }
...
let RouteGuardService = class RouteGuardService {
    constructor(hardAuthenticateService, router) {
        this.hardAuthenticateService = hardAuthenticateService;
        this.router = router;
    }
...
let UsererrorComponent = class UsererrorComponent {
    constructor() {
